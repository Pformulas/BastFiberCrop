                ...
                <div class="inline fields">
                    <div class="four wide field">
                        <div class="ui input focus">
                            <input type="text" placeholder="序列ID" name="id">
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="eight wide column">
            <table class="ui striped table">
                ...
                <tr>
                    <td style="width:100px">${bean.id }</td>
                    <td style="width:100px">${bean.gene }</td>
                    <td style="width:100px">${bean.cds }</td>
                    <td style="width:100px">${bean.pro }</td>
                </tr>
                </c:forEach>
