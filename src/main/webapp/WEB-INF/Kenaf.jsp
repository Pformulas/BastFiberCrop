...
<div class="ui stackable doubling one column grid" style="font-size: 18px;">
    ...
    <div class="row">
        ...
        <div class="eight wide column">
            <form class="ui form" method="post" action="KenafPost.do" name="id">
                <!--第一个搜索框-->
                ...
                <!--按钮-->
                <div class="inline fields" style="margin-top: 176px">
...
<!--底部-->
<div class="ui centered grid" style="margin-top: 50px">
