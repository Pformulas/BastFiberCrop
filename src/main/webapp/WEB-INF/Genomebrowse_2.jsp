...
<div class="ui inverted fixed menu Imenu">
    ...
    <div class="right inverted secondary menu left_menu">
        ...
        <div class="ui dropdown item">Genome browse<i class="icon dropdown"></i>
            <div class="menu">
                <a href="Genomebrowse_1.do" class="item">Jute</a>
                <a href="Genomebrowse_1.do" class="item">Kenaf</a>
                <a href="Genomebrowse_1.do" class="item">Hemp</a>
            </div>
        </div>
...
<div class="ui stackable doubling one column grid" style="font-size: 18px;">
    ...
    <div class="one column row">
        ...
        <div class="five wide column">
            <form action="Genomebrowse_2_snp.do" class="ui form" method="post">
                <div class="ui input focus">
                    <input type="text" placeholder="物种名称" name="snp_id">
                </div>
                <button class="ui inverted green large button" style="margin-left: 50px;">搜索</button>
            </form>
        </div>
        <div class="three wide middle aligned column" style="font-size: 16px;">
            按照材料的名称或者编号进行搜索，例如：黄红麻
        </div>
        <div class="four wide column"></div>
    </div>
    <!--第二个搜索框-->
    <div class="row">
        ...
        <div class="four wide column">
            <form action="Genomebrowse_2_chrom.do" class="ui form"  method="post">
                <div class="ui input focus">
                    <input type="text" placeholder="染色体标号" name="chrom">
                </div>
                <button class="ui inverted green large button" style="margin-left: 50px;">搜索</button>
            </form>
        </div>
        ...
        <div class="two wide column">
            <form action="" class="ui form">
                <div class="ui mini input focus">
                    <input type="text" placeholder="起始位置"/>
                </div>
                <div class="ui mini input focus">
                    <input type="text" placeholder="终止位置"/>
                </div>
            <button class="ui inverted green large button" style="margin-top:30px;">搜索</button>
            </form>
        </div>
    ...
    <div class="row"></div>
        <div class="row">
    	 ...
    	 <div class="two wide column">
    	 	<a class="ui inverted green large button" href="Genomebrowse_2_chrom.do?currentPage=${page.currentPage - 1 }&chrom=${chrom}"
